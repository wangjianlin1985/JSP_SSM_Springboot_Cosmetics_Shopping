...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">化妆品销售</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=1">口红</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=2">粉底液</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=3">眉笔</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=4">眼影</a></li> 
                ...
                <li><a href="<%=basePath %>Notice/frontlist">公告</a></li>
